    ...
    <div className="p-3 space-y-4">
      <Card className="p-4">
        ...
        <p className="mt-4 text-sm text-gray-600">
          This is a placeholder. Wire to SQL views/RPCs (e.g., payroll summaries, headcount by department,
          attrition, leave utilization) and render tables/exports here.
        </p>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-4">
          <div className="border rounded p-3">
            <div className="font-medium">Headcount by Department</div>
            <div className="text-xs text-gray-500 mb-2">Range: {range.start} → {range.end}</div>
